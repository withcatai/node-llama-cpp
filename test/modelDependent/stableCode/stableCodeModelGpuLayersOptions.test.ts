        ...
        describe("Resolve the correct number of GPU layers", async () => {
            ...
            it("attempts to resolve 16 gpuLayers", () => {
                {
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("9530");
                }
                try {
                    resolveGpuLayers(16, {
                        totalVram: s1GB * 6,
            ...
            it("attempts to resolve 32 gpuLayers", () => {
                {
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("11565");
                }
                try {
                    resolveGpuLayers(32, {
                        totalVram: s1GB * 6,
            ...
            it('attempts to resolve "max"', () => {
...

                {
                    ...
                    expect(res.gpuLayers).to.eql(33);
                    expect(res.contextSize).to.toMatchInlineSnapshot("5852");
                }
                {
                    const res = resolveGpuLayers("max", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.gpuLayers).to.eql(33);
                    expect(res.contextSize).to.toMatchInlineSnapshot("6995");
                }
                {
                    const res = resolveGpuLayers("max", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.gpuLayers).to.eql(33);
                    expect(res.contextSize).to.toMatchInlineSnapshot("8137");
                }
            });
            ...
            it('attempts to resolve "auto"', () => {
                ...
                }
                {
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("3742");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("4249");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("1282");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                ...
                }
                {
                    ...
                    expect(res.gpuLayers).to.toMatchInlineSnapshot("33");
                    expect(res.contextSize).to.toMatchInlineSnapshot("3853");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.gpuLayers).to.toMatchInlineSnapshot("33");
                    expect(res.contextSize).to.toMatchInlineSnapshot("4424");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.gpuLayers).to.toMatchInlineSnapshot("33");
                    expect(res.contextSize).to.toMatchInlineSnapshot("5281");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                ...
                }
                {
                    ...
                    expect(res.gpuLayers).to.toMatchInlineSnapshot("33");
                    expect(res.contextSize).to.toMatchInlineSnapshot("6709");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.gpuLayers).to.toMatchInlineSnapshot("33");
                    expect(res.contextSize).to.toMatchInlineSnapshot("7281");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                ...
                }
                {
                    ...
                    expect(res.gpuLayers).to.toMatchInlineSnapshot("33");
                    expect(res.contextSize).to.toMatchInlineSnapshot("9280");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.gpuLayers).to.toMatchInlineSnapshot("33");
                    expect(res.contextSize).to.toMatchInlineSnapshot("10994");
                }
                {
                    const res = resolveGpuLayers("auto", {
                        totalVram: s1GB * 6,
            ...
            it("attempts to resolve {min?: number, max?: number}", () => {
...

                {
                    ...
                    expect(res.gpuLayers).to.eql(16);
                    expect(res.contextSize).to.toMatchInlineSnapshot("14593");
                }
                try {
                ...
                }
                {
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("9020");
                }
                {
                    const res = resolveGpuLayers({min: 16, max: 24}, {
                        totalVram: s1GB * 6,
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("8207");
                }
            });
            ...
            it("attempts to resolve {fitContext?: {contextSize?: number}}", () => {
                ...
                }
                {
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("4959");
                    expect(res.contextSize).to.be.gte(contextSize);
                }
                {
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("8537");
                    expect(res.contextSize).to.be.gte(contextSize);
                }
                {
                    const contextSize = 8192;
                    ...
                    expect(res.contextSize).to.toMatchInlineSnapshot("9618");
                    expect(res.contextSize).to.be.gte(contextSize);
                }
                {
                    const contextSize = 8192;
