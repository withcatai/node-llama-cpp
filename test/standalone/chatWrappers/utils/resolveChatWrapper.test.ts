...
describe("resolveChatWrapper", () => {
    ...
    test("should resolve to specialized QwenChatWrapper - QwQ", {timeout: 1000 * 60 * 60 * 2}, async () => {
        const chatWrapper = resolveChatWrapper({
            customWrapperSettings: {
                jinjaTemplate: {
    ...
    test("should resolve to specialized QwenChatWrapper 2 - Qwen 3", {timeout: 1000 * 60 * 60 * 2}, async () => {
        const chatWrapper = resolveChatWrapper({
            customWrapperSettings: {
                jinjaTemplate: {
    ...
    test("should resolve to specialized QwenChatWrapper - Qwen 3.5", {timeout: 1000 * 60 * 60 * 2}, async () => {
        const chatWrapper = resolveChatWrapper({
            customWrapperSettings: {
                jinjaTemplate: {
