...
import type {NoulQuestionInput, QuestionInput, ScoreQuestionInput} from "./createQuestionInputs.js";

export const decisionAnswerMinimumTopLogits = 20;
export function createDecisionAnswer(
    input: NoulQuestionInput | ScoreQuestionInput,
